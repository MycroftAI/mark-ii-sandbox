...
#define STANDARD_STARTFILE_PREFIX_1 "/gnu/store/gfjp8gfv4xxschbaxvldpigadfwqazhw-glibc-2.33/lib"
...
#define GNU_USER_TARGET_LIB_SPEC "-L/gnu/store/gfjp8gfv4xxschbaxvldpigadfwqazhw-glibc-2.33/lib %{!static:-rpath=/gnu/store/gfjp8gfv4xxschbaxvldpigadfwqazhw-glibc-2.33/lib %{!static-libgcc:-rpath=/gnu/store/z7aai45vm919fhhhf9rsl7vhgvzimmrn-gfortran-10.3.0-lib/lib -lgcc_s}} " \
  "%{pthread:-lpthread} " \
