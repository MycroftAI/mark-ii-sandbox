...
def check_output(*popenargs, timeout=None, **kwargs):
    ...
    >>> check_output(["/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh", "-c",
...
class Popen(object):
    ...
    if _mswindows:
        ...
        def _execute_child(self, args, executable, preexec_fn, close_fds,
            ...
            if shell:
                # On Android the default shell is at '/system/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh'.
                unix_shell = ('/system/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh' if
                          hasattr(sys, 'getandroidapilevel') else '/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh')
