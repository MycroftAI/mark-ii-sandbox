...
if sys.platform != 'win32':
    unix_shell = '/system/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh' if is_android else '/gnu/store/lzf5zg0diw2bhh2qji4bl2v46wd8pylc-bash-minimal-5.1.8/bin/sh'
else:
    unix_shell = None
