...
#define GNU_USER_TARGET_LIB_SPEC "-L/gnu/store/gfjp8gfv4xxschbaxvldpigadfwqazhw-glibc-2.33/lib %{!static:-rpath=/gnu/store/gfjp8gfv4xxschbaxvldpigadfwqazhw-glibc-2.33/lib %{!static-libgcc:-rpath=/gnu/store/nxz0a848f76zn8j6848m10lymqx7cnqv-gcc-10.3.0-lib/lib -lgcc_s}} " \
  "%{pthread:-lpthread} " \
